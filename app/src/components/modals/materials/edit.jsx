...
const EditMaterialModal = ({ data, onEdit = (data) => {} }) => {
  ...
  const [type, setType] = createSignal(data.type);

  return (
    <div
      class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
      id={`editMaterialModal-${data._id}`}
      tabindex="-1"
      aria-labelledby={`editMaterialModal-${data._id}`}
      aria-modal="true"
      role="dialog"
    >
