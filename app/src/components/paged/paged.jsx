...
const Paged = ({ paged, currentPage, onPageClick = (page) => {} }) => {
  return (
    <>
      {paged.length <= 5 &&
        paged.map((paged) => (
          <div
            ...
            } outline-none transition-all duration-300 text-gray-800 hover:text-gray-800 hover:bg-emerald-200 focus:shadow-none cursor-pointer`}
